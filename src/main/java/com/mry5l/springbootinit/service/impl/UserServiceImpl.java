...
import static com.mry5l.springbootinit.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    public static final String SALT = "mry5l";
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            ...
            user.setUserName("牛至国国民");
            user.setLeftNum(10);
            user.setUserAvatar("http://175.178.221.142:8901/api/pdx.jpg");
